...
class Product(models.Model):
    ...
    price1 = models.DecimalField(verbose_name='楽天価格', max_digits=10, decimal_places=3, blank=True, null=True, default=0)
    link1 = models.CharField(verbose_name='楽天店舗に飛ぶ', max_length=500, blank=True, null=True)
    price2 = models.DecimalField(verbose_name='Amazon価格', max_digits=10, decimal_places=3, blank=True, null=True, default=0)
    link2 = models.CharField(verbose_name='Amazon店舗に飛ぶ', max_length=500, blank=True, null=True)
    price3 = models.DecimalField(verbose_name='Yahooショッピング価格', max_digits=10, decimal_places=3, blank=True, null=True, default=0)
