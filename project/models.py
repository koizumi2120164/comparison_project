...
class Review(models.Model):
    ...
    created_by = models.ForeignKey('accounts.CustomUser', verbose_name='投稿者', on_delete=models.PROTECT, max_length=50)
...
class Recently_viewed(models.Model):
    userID = models.ForeignKey('accounts.CustomUser', verbose_name='ユーザーID', on_delete=models.PROTECT, max_length=50)
